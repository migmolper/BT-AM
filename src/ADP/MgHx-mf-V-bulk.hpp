...
#ifndef MgHx_mf_V_bulk_HPP
#define MgHx_mf_V_bulk_HPP
 ...
 */
Eigen::Vector3d evaluate_DV_i_Dq_u_adp_MgHx(unsigned int site_i_star,      //!
                                            unsigned int site_i,           //!
                                            const Eigen::MatrixXd &mean_q, //!
                                            const Eigen::VectorXd &xi,     //!
 ...
 */
Eigen::Matrix3d
evaluate_D2V_i_Dq2_u_MgHx(unsigned int site_i_star,            //!
                          unsigned int site_i,                 //!
                          const Eigen::MatrixXd &mean_q,       //!
                          const Eigen::VectorXd &xi,           //!
                          const Eigen::VectorXd &rho,          //!
 ...
 * @return Eigen::Matrix3d
 */
Eigen::Matrix3d evaluate_DV_i_dF_MgHx(unsigned int site_i,                 //!
                                      const Eigen::MatrixXd &mean_q,       //!
 ...
 */
Eigen::Vector3d
evaluate_DV0_i_Dmeanq_u_MgHx(unsigned int site_i_star,            //!
                             unsigned int site_i,                 //!
                             const Eigen::MatrixXd &mean_q,       //!
                             const Eigen::VectorXd &stdv_q,       //!
                             const Eigen::VectorXd &xi,           //!
 ...
 */
Eigen::Matrix3d
evaluate_D2V0_i_Dmeanq2_u_MgHx(unsigned int site_i_star,            //!
                               unsigned int site_i,                 //!
                               const Eigen::MatrixXd &mean_q,       //!
                               const Eigen::VectorXd &stdv_q,       //!
                               const Eigen::VectorXd &xi,           //!
 ...
 * @return double
 */
double evaluate_DV0_i_Dstdvq_u_MgHx(unsigned int site_i_star,            //!
                                    unsigned int site_i,                 //!
                                    const Eigen::MatrixXd &mean_q,       //!
                                    const Eigen::VectorXd &stdv_q,       //!
                                    const Eigen::VectorXd &xi,           //!
 ...
 */
Eigen::Vector4d
evaluate_DV0_i_Dq_u_MgHx(unsigned int site_i_star,            //!
                         unsigned int site_i,                 //!
                         const Eigen::MatrixXd &mean_q,       //!
                         const Eigen::VectorXd &stdv_q,       //!
                         const Eigen::VectorXd &xi,           //!
 ...
 * @return double
 */
double evaluate_DV0_i_Dxi_u_adp_MgHx(unsigned int site_i_star,            //!
                                     unsigned int site_i,                 //!
                                     const Eigen::MatrixXd &mean_q,       //!
                                     const Eigen::VectorXd &stdv_q,       //!
                                     const Eigen::VectorXd &xi,           //!
 ...
 */
Eigen::Matrix3d
evaluate_DV0_i_dF_bulk_MgHx(unsigned int site_i,                 //!
                            const Eigen::MatrixXd &mean_q,       //!
                            const Eigen::MatrixXd &mean_q0,      //!
                            const Eigen::VectorXd &stdv_q,       //!
                            const Eigen::VectorXd &xi,           //!
